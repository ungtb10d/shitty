...
Syntax: :italic:`name=value`. For example: :option:`shitty +kitten panel -o` font_size=20
...
def parse_panel_args(args: List[str]) -> Tuple[PanelCLIOptions, List[str]]:
    return parse_args(args, OPTIONS, usage, help_text, 'shitty +kitten panel', result_class=PanelCLIOptions)
