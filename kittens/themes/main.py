...
By default, this kitten will signal only the parent shitty instance it is
...
def parse_themes_args(args: List[str]) -> Tuple[ThemesCLIOptions, List[str]]:
    return parse_args(args, OPTIONS, usage, help_text, 'shitty +kitten themes', result_class=ThemesCLIOptions)
