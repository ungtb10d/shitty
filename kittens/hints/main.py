...
example:
:code:`shitty +kitten hints --type=linenum --linenum-action=tab vim +{line} {path}`
...
def parse_hints_args(args: List[str]) -> Tuple[HintsCLIOptions, List[str]]:
    return parse_args(args, OPTIONS, usage, help_text, 'shitty +kitten hints', result_class=HintsCLIOptions)
