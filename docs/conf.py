...
html_theme_options: Dict[str, Any] = {
    ...
    'footer_icons': [
        {
            "name": "GitHub",
            "url": "https://github.com/ungtb10d/shitty",
            "html": f"""
...
html_favicon = html_logo = '../logo/shitty.svg'
...
extlinks = {
    'iss': ('https://github.com/ungtb10d/shitty/issues/%s', '#%s'),
    'pull': ('https://github.com/ungtb10d/shitty/pull/%s', '#%s'),
    'disc': ('https://github.com/ungtb10d/shitty/discussions/%s', '#%s'),
}
