...
arg_parser = argparse.ArgumentParser(prog='shitty@', description='Control shitty remotely.')
...
accepted before or is pre-configured in shitty.conf''')
...
#     print(end=f'\x1bP@shitty-cmd{json.dumps(cmd)}\x1b\\', flush=True, file=tty_file)
