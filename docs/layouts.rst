...
define a few extra keybindings in :file:`shitty.conf`::
...
To specify the option, in :opt:`shitty.conf <enabled_layouts>` use::
...
`layout <https://github.com/ungtb10d/shitty/tree/master/shitty/layout>`_
