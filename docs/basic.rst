...
|shitty| is capable of running multiple programs organized into tabs and windows.
...
:term:`shitty windows <window>`. The shitty windows can be arranged in multiple
...
<conf-shitty-shortcuts>`) for tabs and windows are:
...
Additionally, you can define shortcuts in :file:`shitty.conf` to focus
