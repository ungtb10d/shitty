...
|shitty| has extensions to the legacy terminal protocol, to enable advanced
features. These are typically in the form of new or re-purposed escape codes.
While these extensions are currently |shitty| specific, it would be nice to get
...
<https://github.com/ungtb10d/shitty/issues>`__.
