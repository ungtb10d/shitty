...
You can use this shitten to draw a GPU accelerated panel on the edge of your
...
.. note::
    ...
    This shitten currently only works on X11 desktops

Using this shitten is simple, for example::

    shitty +shitten panel sh -c 'printf "\n\n\nHello, world."; sleep 5s'
...
.. include:: ../generated/cli-shitten-panel.rst
