...
:file:`shitty.conf`. It is very powerful and allows sending the contents of the
...
.. code-block:: python
    ...
    from shitty.window import Window
...
in the window and ``window.id`` is the internal shitty ``id`` of the window.
