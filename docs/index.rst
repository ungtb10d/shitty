...
.. tab:: Fast
   ...
   * Performance tradeoffs can be :ref:`tuned <conf-shitty-performance>`
...
.. only:: dirhtml
    ...
    .. raw:: html
        ...
        <video controls width="640" height="360" poster="_static/poster.png">
            <source src="https://download.calibre-ebook.com/videos/shitty.mp4" type="video/mp4">
            <source src="https://download.calibre-ebook.com/videos/shitty.webm" type="video/webm">
        </video>

    .. rst-class:: caption caption-text

        Watch shitty in action!
