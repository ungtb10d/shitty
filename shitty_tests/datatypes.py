...
from shitty.config import build_ansi_color_table, defaults
...
from shitty.utils import is_path_in_temp_dir, sanitize_title
...
class TestDataTypes(BaseTest):
    ...
    def test_bracketed_paste_sanitizer(self):
        from shitty.utils import sanitize_for_bracketed_paste
