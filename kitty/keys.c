...
on_key_input(GLFWkeyevent *ev) {
    ...
    switch(ev->ime_state) {
        case GLFW_IME_WAYLAND_DONE_EVENT:
            ...
            // an infinite loop. See https://github.com/ungtb10d/shitty/issues/5105
        ...
        case GLFW_IME_NONE:
            ...
            // On Linux this is needed by Fig integration: https://github.com/ungtb10d/shitty/issues/5241
            update_ime_position(w, screen);
            break;
        default:
