...
from shitty.fonts.box_drawing import (
    BufType, distribute_dots, render_box_char, render_missing_glyph
)
from shitty.options.types import Options, defaults
from shitty.typing import CoreTextFont, FontConfigPattern
from shitty.types import _T
...
def test_render_string(
    ...
    from shitty.fast_data_types import concat_cells, current_fonts
