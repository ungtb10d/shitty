...
if TYPE_CHECKING:
    from shitty.cli_stub import DetachWindowRCOptions as CLIOptions
...
class DetachWindow(RemoteCommand):
    ...
    desc = (
        ...
        ' or add them to the specified tab. Use the special value :code:`new` for :option:`shitty @ detach-window --target-tab`'
