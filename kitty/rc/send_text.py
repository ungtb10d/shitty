...
from shitty.fast_data_types import KeyEvent as WindowSystemKeyEvent, get_boss
from shitty.key_encoding import decode_key_event_as_window_system_key
from shitty.options.utils import parse_send_text_bytes
...
if TYPE_CHECKING:
    from shitty.cli_stub import SendTextRCOptions as CLIOptions
...
class SendText(RemoteCommand):
    ...
    desc = (
        ...
        ' and :code:`\\u21fa` to send unicode characters. If you use the :option:`shitty @ send-text --match` option'
