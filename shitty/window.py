...
class Window:
    ...
    def send_cmd_response(self, response: Any) -> None:
        self.screen.send_escape_code_to_child(DCS, '@shitty-cmd' + json.dumps(response))
    ...
    @ac('mouse', '''
        ...
        For examples, see :ref:`conf-shitty-mouse.mousemap`
        ''')
    def mouse_handle_click(self, *actions: str) -> None:
        for a in actions:
            ...
            if a == 'prompt':
                ...
                # can interfere with that. See https://github.com/ungtb10d/shitty/issues/4128
    ...
    def paste_text(self, text: Union[str, bytes]) -> None:
        if text and not self.destroyed:
            ...
            if self.screen.in_bracketed_paste_mode:
                ...
                # newlines in pasted text see https://github.com/ungtb10d/shitty/issues/994
                text = text.replace(b'\r\n', b'\n').replace(b'\n', b'\r')
    ...
    @ac('misc', '''
    Display the specified shitty documentation, preferring a local copy, if found.
