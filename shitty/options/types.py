...
from shitty.fast_data_types import Color, SingleKey
import shitty.fast_data_types
import shitty.fonts
from shitty.options.utils import AliasMap, KeyDefinition, KeyMap, MouseMap, MouseMapping, SequenceMap, TabBarMarginHeight
import shitty.options.utils
from shitty.types import FloatEdges
import shitty.types
...
class Options:
    active_border_color: typing.Optional[shitty.fast_data_types.Color] = Color(0, 255, 0)
    ...
    copy_on_select: str = ''
    cursor: typing.Optional[shitty.fast_data_types.Color] = Color(204, 204, 204)
    cursor_beam_thickness: float = 1.5
    cursor_blink_interval: float = -1.0
    cursor_shape: int = 1
    cursor_stop_blinking_after: float = 15.0
    cursor_text_color: typing.Optional[shitty.fast_data_types.Color] = Color(17, 17, 17)
    ...
    selection_background: typing.Optional[shitty.fast_data_types.Color] = Color(255, 250, 205)
    selection_foreground: typing.Optional[shitty.fast_data_types.Color] = Color(0, 0, 0)
    shell: str = '.'
    ...
    tab_bar_background: typing.Optional[shitty.fast_data_types.Color] = None
    tab_bar_edge: int = 3
    tab_bar_margin_color: typing.Optional[shitty.fast_data_types.Color] = None
    ...
    url_prefixes: typing.Tuple[str, ...] = ('file', 'ftp', 'ftps', 'gemini', 'git', 'gopher', 'http', 'https', 'irc', 'ircs', 'shitty', 'mailto', 'news', 'sftp', 'ssh') # noqa
    url_style: int = 3
    visual_bell_color: typing.Optional[shitty.fast_data_types.Color] = None
...
if is_macos:
    ...
    defaults.map.append(KeyDefinition(trigger=SingleKey(mods=9, key=47), definition='open_url https://sw.ungtb10d.net/shitty/'))  # noqa
defaults.mouse_map = [
    # click_url_or_select
