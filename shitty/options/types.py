...
import shitty.conf.utils
from shitty.constants import is_macos
import shitty.constants
from shitty.options.utils import KeyDefinition, KeyMap, MouseMap, MouseMapping, SequenceMap, TabBarMarginHeight
import shitty.options.utils
from shitty.rgb import Color
import shitty.rgb
from shitty.types import FloatEdges, SingleKey
import shitty.types
...
class Options:
    active_border_color: typing.Optional[shitty.rgb.Color] = Color(red=0, green=255, blue=0)
    ...
    cursor_text_color: typing.Optional[shitty.rgb.Color] = Color(red=17, green=17, blue=17)
    ...
    selection_foreground: typing.Optional[shitty.rgb.Color] = Color(red=0, green=0, blue=0)
    shell: str = '.'
    ...
    tab_bar_background: typing.Optional[shitty.rgb.Color] = None
    tab_bar_edge: int = 3
    ...
    shitten_alias: typing.Dict[str, typing.List[str]] = {}
    symbol_map: typing.Dict[typing.Tuple[int, int], str] = {}
    map: typing.List[shitty.options.utils.KeyDefinition] = []
    keymap: KeyMap = {}
    sequence_map: SequenceMap = {}
    mouse_map: typing.List[shitty.options.utils.MouseMapping] = []
    mousemap: MouseMap = {}
...
defaults.map = [
    ...
    # open_url
    KeyDefinition(False, KeyAction('shitten', ('hints',)), 1024, False, 101, ()),
    # insert_selected_path
    KeyDefinition(True, KeyAction('shitten', ('hints', '--type path --program -')), 1024, False, 112, (SingleKey(mods=0, is_native=False, key=102),)),
    # open_selected_path
    KeyDefinition(True, KeyAction('shitten', ('hints', '--type path')), 1024, False, 112, (SingleKey(mods=1, is_native=False, key=102),)),
    # insert_selected_line
    KeyDefinition(True, KeyAction('shitten', ('hints', '--type line --program -')), 1024, False, 112, (SingleKey(mods=0, is_native=False, key=108),)),
    # insert_selected_word
    KeyDefinition(True, KeyAction('shitten', ('hints', '--type word --program -')), 1024, False, 112, (SingleKey(mods=0, is_native=False, key=119),)),
    # insert_selected_hash
    KeyDefinition(True, KeyAction('shitten', ('hints', '--type hash --program -')), 1024, False, 112, (SingleKey(mods=0, is_native=False, key=104),)),
    # goto_file_line
    KeyDefinition(True, KeyAction('shitten', ('hints', '--type linenum')), 1024, False, 112, (SingleKey(mods=0, is_native=False, key=110),)),
    # open_selected_hyperlink
    KeyDefinition(True, KeyAction('shitten', ('hints', '--type hyperlink')), 1024, False, 112, (SingleKey(mods=0, is_native=False, key=121),)),
    # toggle_fullscreen
    ...
    KeyDefinition(False, KeyAction('shitten', ('unicode_input',)), 1024, False, 117, ()),
    # edit_config_file
    KeyDefinition(False, KeyAction('edit_config_file'), 1024, False, 57365, ()),
    # shitty_shell
    KeyDefinition(False, KeyAction('shitty_shell', ('window',)), 1024, False, 57344, ()),
...
if is_macos:
    ...
    defaults.map.append(KeyDefinition(False, KeyAction('shitten', ('unicode_input',)), 12, False, 32, ()))
