...
render_line(PyObject *self UNUSED, PyObject *args, PyObject *kw) {
    ...
    // shitty +runpy "from shitty.fast_data_types import *; open('/tmp/test.rgba', 'wb').write(freetype_render_line())" && convert -size 800x60 -depth 8 /tmp/test.rgba /tmp/test.png && icat /tmp/test.png
