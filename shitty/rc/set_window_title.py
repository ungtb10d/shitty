...
if TYPE_CHECKING:
    from shitty.cli_stub import SetWindowTitleRCOptions as CLIOptions
...
class SetWindowTitle(RemoteCommand):
    ...
    desc = (
        'Set the title for the specified window(s). If you use the :option:`shitty @ set-window-title --match` option'
