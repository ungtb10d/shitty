...
if TYPE_CHECKING:
    from shitty.cli_stub import DetachTabRCOptions as CLIOptions
...
class DetachTab(RemoteCommand):
    ...
    desc = (
        ...
        ' or add them to the OS window containing the tab specified by :option:`shitty @ detach-tab --target-tab`'
    )
