...
from shitty.cli_stub import LaunchCLIOptions
from shitty.launch import (
...
if TYPE_CHECKING:
    from shitty.cli_stub import LaunchRCOptions as CLIOptions
...
class Launch(RemoteCommand):
    ...
    desc = (
        ...
        ' :italic:`shitty @ launch --title Email mutt`.'
    )
