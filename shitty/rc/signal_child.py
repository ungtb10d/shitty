...
if TYPE_CHECKING:
    from shitty.cli_stub import SignalChildRCOptions as CLIOptions
...
class SignalChild(RemoteCommand):
    ...
    desc = (
        ...
        ' If you use the :option:`shitty @ signal-child --match` option'
        ...
        ' You can also map :ac:`signal_child` to a shortcut in :file:`shitty.conf`, for example::\n\n'
