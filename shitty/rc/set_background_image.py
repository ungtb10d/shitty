...
if TYPE_CHECKING:
    from shitty.cli_stub import SetBackgroundImageRCOptions as CLIOptions
...
type=bool-set
default=false
Don't wait for a response from shitty. This means that even if setting the background image
