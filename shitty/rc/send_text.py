...
from shitty.fast_data_types import KeyEvent as WindowSystemKeyEvent
...
class SendText(RemoteCommand):
    ...
    desc = (
        ...
        ' and :italic:`\\u21fa` to send unicode characters. If you use the :option:`shitty @ send-text --match` option'
