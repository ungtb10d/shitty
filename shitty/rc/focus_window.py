...
if TYPE_CHECKING:
    from shitty.cli_stub import FocusWindowRCOptions as CLIOptions
...
type=bool-set
default=false
Don't wait for a response from shitty. This means that even if no matching window is found,
