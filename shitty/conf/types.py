...
import shitty.conf.utils as generic_parsers
...
def remove_markup(text: str) -> str:
    ...
    def sub(m: Match) -> str:
        if m.group(1) == 'ref':
            return {
                'layouts': 'https://sw.ungtb10d.net/shitty/index.html#layouts',
                'sessions': 'https://sw.ungtb10d.net/shitty/index.html#sessions',
                'functional': 'https://sw.ungtb10d.net/shitty/keyboard-protocol.html#functional-key-definitions',
            }[m.group(2)]
