...
# the functions `font_for_cell` and `box_glyph_id` in `shitty/fonts.c`.
#
...
def test_char(ch: str, sz: int = 48) -> None:
    # shitty +runpy "from shitty.fonts.box_drawing import test_char; test_char('XXX')"
    from shitty.fast_data_types import concat_cells, set_send_sprite_to_gpu
