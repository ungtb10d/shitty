        ...
        for fname in filenames:
            if fname.endswith('.html'):
                with open(os.path.join(dirpath, fname), 'r+b') as f:
                    ...
                    html = html.replace('<!-- shitty analytics placeholder -->', analytics, 1)
                    f.seek(0), f.truncate()
    ...
    def create_release(self, releases: Iterable[Dict[str, str]]) -> Dict[str, Any]:
        ...
        r = self.requests.post(
            ...
            data=json.dumps({
                ...
                ' For changelog, see https://sw.ungtb10d.net/shitty/changelog.html'
...
def run_upload(args: Any) -> None:
    ...
    for f, desc in {
        ...
        'linux/64/sw/dist/shitty-{}-x86_64.txz': 'Linux amd64 binary bundle',
        'linux/32/sw/dist/shitty-{}-i686.txz': 'Linux x86 binary bundle',
    }.items():
