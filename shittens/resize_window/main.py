...
from shitty.cli_stub import RCOptions, ResizeCLIOptions
from shitty.constants import version
from shitty.key_encoding import CTRL, EventType, KeyEvent
from shitty.rc.base import command_for_name, parse_subcommand_cli
from shitty.remote_control import encode_send, parse_rc_args
...
class Resize(Handler):
    ...
    def initialize(self) -> None:
        global global_opts
        global_opts = parse_rc_args(['shitty', '@resize-window'])[0]
