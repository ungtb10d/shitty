...
def parse_unicode_input_args(args: List[str]) -> Tuple[UnicodeCLIOptions, List[str]]:
    return parse_args(args, OPTIONS, usage, help_text, 'shitty +shitten unicode_input', result_class=UnicodeCLIOptions)
