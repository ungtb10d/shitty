...
from shitty.constants import appname, is_macos
from shitty.os_window_size import WindowSizeData
from shitty.fast_data_types import make_x11_window_a_dock_window
...
def main(sys_args: List[str]) -> None:
    ...
    from shitty.main import main as real_main, run_app
