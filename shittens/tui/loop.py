...
from shitty.key_encoding import (
    ALT, CTRL, PRESS, RELEASE, REPEAT, SHIFT, backspace_key, decode_key_event,
    enter_key
)
from shitty.typing import ImageManagerType, KeyEventType, Protocol
from shitty.utils import ScreenSizeGetter, screen_size_function, write_all
...
class Debug:
    ...
    def __call__(self, *a: Any, **kw: Any) -> None:
        ...
        print(*a, **kw)
        stext = buf.getvalue()
        text = b'\x1bP@shitty-print|' + standard_b64encode(stext.encode('utf-8')) + b'\x1b\\'
