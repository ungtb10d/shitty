...
from shitty.conf.utils import positive_float, positive_int
from shitty.fast_data_types import create_canvas
from shitty.typing import (
    CompletedProcess, GRT_a, GRT_d, GRT_f, GRT_m, GRT_o, GRT_t, HandlerType
)
from shitty.utils import ScreenSize, find_exe, fit_image
...
def render_image(
    ...
    def check_resize(frame: Frame) -> None:
        ...
        # size. See https://github.com/ungtb10d/shitty/issues/276 for examples
...
class ImageManager:
    ...
    def __enter__(self) -> None:
        import tempfile
        self.tdir = tempfile.mkdtemp(prefix='shitten-images-')
