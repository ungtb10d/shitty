...
help_text = '''\
Query the terminal this shitten is run in for various
...
If a particular query is unsupported by the running shitty version,
...
def main(args: List[str] = sys.argv) -> None:
    cli_opts, items_ = parse_args(
        ...
        usage,
        help_text,
        '{} +shitten query_terminal'.format(appname),
