...
def fetch_themes(
    name: str = 'shitty-themes',
    url: str = 'https://codeload.github.com/ungtb10d/shitty-themes/zip/master',
    cache_age: float = 1,
) -> str:
...
class Theme:
    ...
    def save_in_conf(self, confdir: str, reload_in: str, config_file_name: str = 'shitty.conf') -> None:
