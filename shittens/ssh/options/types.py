...
import typing
import shittens.ssh.copy

if typing.TYPE_CHECKING:
    choices_for_askpass = typing.Literal['unless-set', 'ssh', 'native']
    choices_for_remote_shitty = typing.Literal['if-needed', 'no', 'yes']
else:
    choices_for_askpass = str
    choices_for_remote_shitty = str
...
class Options:
    ...
    interpreter: str = 'sh'
    login_shell: str = ''
    remote_dir: str = '.local/share/shitty-ssh-shitten'
    remote_shitty: choices_for_remote_shitty = 'if-needed'
    share_connections: bool = True
    shell_integration: str = 'inherited'
    copy: typing.Dict[str, shittens.ssh.copy.CopyInstruction] = {}
