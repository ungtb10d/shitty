...
import typing
from shitty.conf.utils import KeyAction, shittensKeyMap
...
class Options:
    ...
    margin_filler_bg: typing.Optional[shitty.fast_data_types.Color] = None
    ...
    select_fg: typing.Optional[shitty.fast_data_types.Color] = Color(0, 0, 0)
    ...
    map: typing.List[typing.Tuple[shitty.types.ParsedShortcut, shitty.conf.utils.KeyAction]] = []
    key_definitions: shittensKeyMap = {}
