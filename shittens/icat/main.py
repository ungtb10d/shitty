...
convenience method to query the window size if using shitty icat from a
...
def main(args: List[str] = sys.argv) -> None:
    global can_transfer_with_files
    cli_opts, items_ = parse_args(args[1:], options_spec, usage, help_text, '{} +shitten icat'.format(appname), result_class=IcatCLIOptions)
